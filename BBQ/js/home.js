...
const UIManager = {
    ...
    // Replace your showToast function in home.js with this:
    ...
    showToast(message, type = 'success') {
        ...
        const existingToasts = $('.toast-notification').length;
        const bottomPosition = 20 + (existingToasts * 80);

        console.log('🎨 Toast type:', type, '→ Color:', bgColor, '→ Position:', bottomPosition);
...
}; // ← UIManager closes here
function repositionToasts() {
    $('.toast-notification').each(function (index) {
        $(this).css({
